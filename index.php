...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="images/tsf.png" />
...
<body id="page-top">
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <a href="index.php" class="navbar-brand">
            <img src="images/tsf.png" height="60" alt="CoolBrand">
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            <img class="masthead-avatar mb-5" src="images/bank.png" alt="" />
        ...
        <div class="container">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card">
                            <img src="images/history.jpg" class="card-img-top" />
                            <div class="card-body">                           
    ...
    <div class="copyright py-4 text-center text-white">
        ...
        <pre style="color:white;">Made by Aryan Biswari</pre>
    </div>
